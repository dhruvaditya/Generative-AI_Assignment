...
#     with opne(f"{file.name}","wb") as buffer:
...
# Assuming uploaded_file contains the uploaded PDF file
...
def get_vector_store(text_chuks):
...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        pdf_docs=st.file_uploader("Upload your pdf and click submit")
